...
METHOD_LABELS: dict[int, str] = {
    ...
    PLATEGA_METHOD_CARD: "💳 Карты (RUB)",
    PLATEGA_METHOD_CRYPTO: "🪙 Криптовалюта",
}

# Тексты для экранов бота — синхронизированы с опциями Platega в кабинете.
METHOD_COPY: dict[int, dict[str, str]] = {
    PLATEGA_METHOD_SBP_QR: {
        "title": "СБП · QR",
        "summary": (
            "Быстрый перевод через Систему быстрых платежей: откроется QR-код, "
            "его сканируете в приложении банка."
        ),
        "how": (
            "Нажмите «Оплатить» → откроется страница с QR. В банковском приложении "
            "выберите «Оплатить по QR» или «СБП», наведите камеру и подтвердите сумму."
        ),
        "timing": "Зачисление обычно за 1–2 минуты.",
        "note": "Подходит для Сбера, Т‑Банка, ВТБ, Альфа и других банков с СБП.",
    },
    PLATEGA_METHOD_CARD: {
        "title": "Банковская карта",
        "summary": (
            "Оплата картой российского банка на защищённой странице Platega."
        ),
        "how": (
            "Введите номер карты, срок и CVC на странице оплаты. "
            "Банк может запросить код из SMS — это нормальная проверка 3-D Secure."
        ),
        "timing": "Деньги на балансе появляются сразу после подтверждения банком.",
        "note": "Принимаются карты МИР, Visa и Mastercard в рублях.",
    },
    PLATEGA_METHOD_CRYPTO: {
        "title": "Криптовалюта",
        "summary": (
            "Пополнение через криптовалюту — удобно, если нет карты РФ "
            "или привычнее платить USDT и другими монетами."
        ),
        "how": (
            "На странице оплаты выберите монету и сеть, переведите указанную сумму "
            "на выданный адрес. Счёт действует ограниченное время."
        ),
        "timing": "Зачисление после подтверждения в сети — от пары минут до часа.",
        "note": "Курс и сумма фиксируются в момент создания счёта.",
    },
}
...
def method_copy(code: int) -> dict[str, str]:
    return METHOD_COPY.get(code, {
        ...
        "summary": "Оплата через платёжного партнёра Platega.",
        "how": "Следуйте инструкциям на странице оплаты.",
        "timing": "Зачисление обычно в течение нескольких минут.",
        "note": "",
    })
