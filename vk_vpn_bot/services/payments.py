...
METHOD_COPY: dict[int, dict[str, str]] = {
    PLATEGA_METHOD_SBP_QR: {
        "title": "СБП · QR",
        "summary": "QR-код → сканируете в приложении банка.",
        "how": "На странице оплаты отсканируйте QR через «Оплатить по QR» / СБП.",
        "timing": "Обычно 1–2 минуты.",
        "note": "Сбер, Т‑Банк, ВТБ, Альфа и др.",
    },
    PLATEGA_METHOD_CARD: {
        "title": "Карта",
        "summary": "Карта РФ на защищённой странице Platega.",
        "how": "Введите данные карты; банк может запросить SMS-код (3-D Secure).",
        "timing": "Сразу после подтверждения банком.",
        "note": "МИР, Visa, Mastercard в ₽.",
    },
    PLATEGA_METHOD_CRYPTO: {
        "title": "Крипта",
        "summary": "USDT и другие монеты — если нет карты РФ.",
        "how": "Выберите монету и сеть, переведите сумму на адрес со страницы.",
        "timing": "От нескольких минут до часа (сеть).",
        "note": "Курс фиксируется при создании счёта.",
    },
}
