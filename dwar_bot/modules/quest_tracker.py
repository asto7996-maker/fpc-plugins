...
class QuestTracker:
    ...
    def _infer_hunt_mob_name(self, *texts: str) -> str:
        ...
        killish = any(
            k in low
            for k in (
                "поверг", "убей", "убит", "убить", "побежд", "сражён", "сражен",
                "хвост", "туш", "напад",
            )
        )
        # Known mob aliases (SUIS catalog) — prefer specific over generic
        known = (
            ("зигред-воин", "Зигред-воин"),
            ("зигред воин", "Зигред-воин"),
            ("крэтс-вожак", "Крэтс-вожак"),
            ("крейтс-вожак", "Крэтс-вожак"),
            ("неистовый пес", "Неистовый пес"),
            ("пес-демон", "Пес-демон"),
            ("скелет-воин", "Скелет-воин"),
            ("огненная паучиха", "Огненная паучиха"),
            ("пепельный паук", "Пепельный паук"),
            ("крэтс-лидер", "Крэтс-лидер"),
            ("бешеный пес", "Бешеный пес"),
            ("шальной пес", "Шальной пес"),
            ("огненный паук", "Огненный паук"),
            ("дряхлый скелет", "Дряхлый скелет"),
            ("зигред", "Зигред"),
            ("крэтс", "Крэтс"),
            ("крейтс", "Крэтс"),
            ("krats", "Крэтс"),
