...
async def _answer_patched(self: Message, text: str = None, **kwargs):
...
async def _edit_patched(self: Message, text: str, **kwargs):
...
def patch_message_methods():
    Message.answer = _answer_patched
    Message.edit_text = _edit_patched
