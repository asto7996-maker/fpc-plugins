...
# Compact default: primary CTA full-width, secondary actions paired (fits phones).
DEFAULT_MENU_LAYOUT: dict[str, object] = {
    'row_1': {'id': 'row_1', 'buttons': ['home'], 'max_per_row': 1},
    'row_2': {'id': 'row_2', 'buttons': ['subscription', 'referral'], 'max_per_row': 2},
    'row_3': {'id': 'row_3', 'buttons': ['balance', 'support'], 'max_per_row': 2},
