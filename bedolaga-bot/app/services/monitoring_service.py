...
class MonitoringService:
    ...
    async def _send_message_with_logo(
        ...
        # Replace bare unicode with tgmacicons premium <tg-emoji> when HTML is used.
        if text and parse_mode and str(parse_mode).upper() == 'HTML':
                ...
                inline_keyboard=[
                    [
                        build_miniapp_or_callback_button(
                            ...
                            style='success',
                            icon_custom_emoji_id=icon_id('renew') or None,
                        )
                    ],
                    [
                        build_miniapp_or_callback_button(
                ...
                inline_keyboard=[
                    [
                        build_miniapp_or_callback_button(
                            ...
                            style='success',
                            icon_custom_emoji_id=icon_id('buy') or None,
                        )
                    ],
                    [
                        build_miniapp_or_callback_button(
